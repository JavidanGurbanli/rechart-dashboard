  ...
  return (
    <div className={`min-h-screen ${theme.bg} transition-colors duration-300`}>
      <div className="max-w-7xl mx-auto p-6">
        <div
          className={`${theme.cardBg} rounded-lg shadow-lg p-6 mb-6 border ${theme.border}`}
        >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
          <div
            className={`lg:col-span-2 ${theme.cardBg} rounded-lg shadow-lg p-6 border ${theme.border}`}
          >
          ...
          <div
            className={`${theme.cardBg} rounded-lg shadow-lg p-4 border ${theme.border}`}
          >
            <h3
              className={`${theme.text} text-xl font-semibold mb-4 text-center`}
            >
              Category Breakdown
            </h3>
